  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden pb-0">
      ...
      <div className="relative z-10">
        ...
        <AnimatedSection className="relative z-10 max-w-[1320px] mx-auto px-6 md:px-8 py-16 md:py-20" delay={0.575}>
        ...
        {/* 12. FINAL CLOSE - CTA */}
        <AnimatedSection className="relative z-10 max-w-[1320px] mx-auto px-6 md:px-8 py-16 md:py-20" delay={0.65}>
          <CTASection />
        </AnimatedSection>
