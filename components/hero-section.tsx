...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center text-center space-y-8 md:space-y-12 lg:space-y-16 relative z-10 px-6 md:px-8 lg:px-12 max-w-7xl mx-auto pt-32 pb-20">
        <div className="space-y-8 md:space-y-12">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-light text-foreground leading-[1.05] tracking-tight">
            Transform From{" "}
          ...
          <p className="text-xl md:text-2xl lg:text-3xl text-muted-foreground max-w-5xl mx-auto leading-relaxed font-light">
            ...
            <span className="text-foreground font-medium"> Take the assessment to discover your founder archetype.</span>
          </p>
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="glass rounded-3xl p-8 md:p-12 border border-primary/10">
              ...
              <p className="text-lg md:text-xl text-foreground italic leading-relaxed font-medium">
        ...
        <div className="flex flex-col sm:flex-row gap-6 md:gap-8 mt-8 md:mt-12">
          <div className="flex flex-col items-center gap-3">
            <Link href="/quiz" rel="noopener noreferrer">
              <Button className="relative bg-gradient-to-r from-primary to-primary-dark text-primary-foreground hover:from-primary-dark hover:to-primary px-12 py-5 rounded-2xl font-semibold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-primary/20 glow group overflow-hidden">
                <span className="relative z-10">Take FREE Founder Story Assessment</span>
          ...
          <div className="flex flex-col items-center gap-3">
            <Link href="/audit" rel="noopener noreferrer">
              <Button className="relative bg-gradient-to-r from-accent to-accent/80 text-accent-foreground hover:from-accent/90 hover:to-accent px-12 py-5 rounded-2xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-accent/20 group overflow-hidden">
                <span className="relative z-10">Book FREE Audit Call</span>
