...
-- Clean version that handles existing objects gracefully
...
DROP POLICY IF EXISTS "Service role can access all data" ON leads;
DROP POLICY IF EXISTS "Service role can access all data" ON email_sequences;
DROP POLICY IF EXISTS "Service role can access all data" ON sequence_emails;
...
DROP POLICY IF EXISTS "Users can read their own data" ON leads;
DROP POLICY IF EXISTS "Users can read their own data" ON email_sequences;
DROP POLICY IF EXISTS "Users can read their own data" ON sequence_emails;
